              ...
              <form method="POST" class="pt-3">
                <div class="form-group">
                  <select name="hak_akses" id="" class="form-control text-uppercase">
                    ...
                    <?php
                        $SQL = "SELECT * FROM data_user WHERE hak_akses='Admin' or hak_akses='Petugas'";
                  ...
                  <!-- <input type="text" name="password" class="form-control form-control-xs text-uppercase" placeholder="Password" required autofocus> -->
                </div>
                <div class="form-group">
                ...
                <div class="mb-2">
                  <a class="btn btn-block btn-danger btn-lg font-weight-medium auth-form-btn" href="http://localhost/posyandu/">BATAL</a>
                </div>
