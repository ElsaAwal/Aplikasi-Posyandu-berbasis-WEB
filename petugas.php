          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <img src="main/img/logoposyandu.jpg" width="250" height="100" alt="logo">
              </div>
              <h4>LOGIN PETUGAS Puskesmas</h4>
              ...
              <form method="POST" class="pt-3">
                <div class="form-group">
                  <select name="hak_akses" id="" class="form-control text-uppercase">
                    ...
                    <?php
                        $SQL = "SELECT * FROM data_user WHERE hak_akses='Petugas'";
                  ...
                  <!-- <input type="text" name="username" class="form-control form-control-xs text-uppercase" placeholder="Username" required autofocus> -->
                </div>
                <div class="form-group">
                ...
                <div class="mb-2">
                  <a class="btn btn-block btn-danger btn-lg font-weight-medium auth-form-btn" href="http://localhost/bansos/">BATAL</a>
                </div>
    ...
    if(isset($_POST['login'])){
      ...
      $hak_akses = $_POST['hak_akses'];
        ...
        if($jumlah_login > 0){
          ...
          echo '<meta http-equiv="refresh" content="3; url=petugas.php">';
        }
    }
  ?>
